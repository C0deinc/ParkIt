    ...
    if ($account->sign_in()) {
        ...
        if (!isset($_SESSION['first_login'])) {
            ...
            if ($account->is_first_login()) {
                ...
                header('location: home.php'); // Redirect to home page for subsequent logins
                exit();
            }
        }
    } else {
...
<body style="display: flex; justify-content:center; align-items:center;">
    <div>
        ...
        <form action="" method="post">
            ...
            <button type="submit" name="signin" style="background-color: #1363DF;color: White; font-size: 12px; border: none; border-radius: 3px; margin-bottom: 3px; padding: 3px 0; text-align: center; width: 200px;">Sign in</button>
        </form>
