...
<body>
    ...
    <h1 class="text-center page-top" style="color:#3586ff;">OUR STORY</h1>
    <hr class="hr">
    ...
    <div class="container">
        <div class="pt-5 pb-md-4 pb-3 flex-lg-row flex-column-reverse flex-md-column-reverse row">
            ...
            <div class="col-lg-6 col-md-12 col-12 d-flex justify-content-center align-items-center mt-5">
            <lord-icon
