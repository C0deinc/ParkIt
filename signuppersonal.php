...
<body>
    <div class="container">
        <div>
            ...
            <div class="text-center"><b>Sign in to your account</b></div><br>
            <div class="mt-3" style="border-top: 2px groove gray;"></div><br>
        </div>
        <div class="row">
            <form action="./modules/personal.php" method="post">
                ...
                <div class="mb-2" style="font-size: 12px;">
                    ...
                    <input type="text" class="form-control mb-2" id="zipcode" name="zipcode" placeholder="Enter Zip code" style="font-size: 10px;" value="<?php if(isset($_POST['zipcode'])){ echo $_POST['zipcode']; } ?>">
                    <?php
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <div style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                                            <img src="../images/DL-front.jpg" height="120px" width="200px" alt="">
                                        </div>
                                        <br><br>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-center" style="font-size: 12px;">Sample ID</div><br>
                                        <div style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                                            <img src="../images/UMID-front.jpg" height="120px" width="200px" alt="">
                                        </div>
                                        <br><br>
                                        <div style="border: 1px groove grey; border-radius: 10px; padding: 10px;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-center" style="font-size: 12px;">Sample ID</div><br>
                                        <div style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                                            <img src="../images/postal-front.jpg" height="120px" width="200px" alt="">
                                        </div>
                                        <br><br>
                                        <div style="border: 1px groove grey; border-radius: 10px; padding: 10px;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-center" style="font-size: 12px;">Sample ID</div><br>
                                        <div style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                                            <img src="../images/passport-front.png" height="120px" width="200px" alt="">
                                        </div>
                                        <br><br>
                                        <div style="border: 1px groove grey; border-radius: 10px; padding: 10px;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-center" style="font-size: 12px;">Sample ID</div><br>
                                        <div style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                                            <img src="../images/sss-front.jpg" height="120px" width="200px" alt="">
                                        </div>
                                        <br><br>
                                        <div style="border: 1px groove grey; border-radius: 10px; padding: 10px;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-center" style="font-size: 12px;">Sample ID</div><br>
                                        <div style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                                            <img src="../images/prc.jpg" height="120px" width="200px" alt="">
                                        </div>
                                        <br><br>
                                        <div style="border: 1px groove grey; border-radius: 10px; padding: 10px;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-center" style="font-size: 12px;">Sample ID</div><br>
                                        <div style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                                            <img src="../images/HDMF.png" height="120px" width="200px" alt="">
                                        </div>
                                        <br><br>
                                        <div style="border: 1px groove grey; border-radius: 10px; padding: 10px;">
                ...
                <button class="container" type="submit" style="background-color: #1363DF;color: White; font-size: 12px; border: none; border-radius: 5px; margin-bottom: 5px; padding: 5px 0; text-align: center;">Sign up</button>
            </form>
        </div>
        <div class="container">
            ...
            <div class="text-center" style="font-size: 12px; border: 0.1px groove; padding: 3px;"><img src="../images/fbicon.png" height="25" width="25" alt=""> Sign in with Facebook</div><br><br>
