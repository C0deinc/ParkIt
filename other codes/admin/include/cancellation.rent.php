<div class="modal fade" id="cancellation" data-bs-backdrop="static" tabindex="-1" aria-labelledby="cancelrent"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header justify-content-center flex-column">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <h1 class="modal-title fs-5" id="cancelrent" style="font-weight: bold;">CANCELLATION ACCOUNT</h1>
            </div>
