<div class="modal fade" id="cancellation" data-bs-backdrop="static" tabindex="-1" aria-labelledby="cancellationmodal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content p-4">
            <div class="modal-header justify-content-center flex-column">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <h1 class="modal-title fs-5" id="cancellationmodal" style="font-weight: bold;">LIST OF CANCELLATION</h1>
            </div>
            <div class="location_info">
                ...
                <div class="pagination history d-flex flex-direction-row flex-end">
                    <a href="#">&laquo;</a>
                    <a href="#">1</a>
                    <a href="#">2</a>
                    <a href="#">&raquo;</a>
