...
<head>
    ...
    <title>Reported Incidents Page</title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-6" style="padding-top: 5px;">
                ...
                <div class="table-box">
                    ...
                    <div class="table-row">
                        ...
                        <div class="table-cell">
                            <button type="button" class="butm" data-bs-toggle="modal" data-bs-target="#cancellation">
