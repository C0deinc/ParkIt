        ...
        <div class="row border-bottom">
          <div class="col-2 py-1 px-0">
            <div class="profile d-flex justify-content-center align-items-center">
              <img src="/imahe/jau.jpg" class="rounded-circle" alt="" srcset="" style="width: 10vw; height: 4vh;">
            </div>
        ...
        <div class="card">
          <div class="row">
            <div class="col-4 px-0">
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide" style="height: 10vh;" data-bs-ride="carousel">
            ...
            <div class="col-6 px-2">
              ...
              <div class="detail" style="font-size: 0.6rem;">
                <span><i class="fa fa-map-marker" aria-hidden="true"></i> Purok 2, Gumamela street</span>
                <span><span class="fa fa-star checked" style="font-size: 0.5rem;"></span> 1.5k Reviews</span>
              </div>
            </div>
      ...
      <section class="vehicle">
        <form action="POST">
          ...
          <div class="pay d-flex justify-content-end">
            <button type="submit" class="border-0 rounded" style="width: 25vw; height:5vh;">
              Pay
            </button>
          </div>
        </form>
