<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #06283D;">
        ...
        <div class="navbar-collapse offcanvas-collapse ms-auto">
            <ul class="navbar-nav ms-auto">
                ...
                <a class="nav-link dropdown-toggle color-white" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="true">
                    <img src="/admin/images/photo.png" class="rounded-circle me-2" alt="User Image" width="30px" height="30px" style="position: relative; top: -2px;"> <!-- Adjust position as needed -->
                    Charl's
                </a>
