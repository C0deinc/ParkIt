...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            require_once('../include/modal.warning.php');
            ?>

            <!-- Main Content -->
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-6">
            <div class="d-flex ms-5 mt-4">
                    <h4 class="h3 m" style="font-weight: bold;">Verified Accounts</h1>
                </div>
                            ...
                            <table class="table text-center ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;">Mohammad Sali Jauhari</td>
                                        <td style="vertical-align: middle;">Personal</td>
                                        <td style="vertical-align: middle;">01/20/2024</td>
                                        <td style="vertical-align: middle;">
